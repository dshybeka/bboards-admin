	...
	<body>
		...
		<div id="show-board" class="content scaffold-show" role="main">
			...
			<ol class="property-list board">
				...
				<li class="fieldcontain">
					<span id="mplng-label" class="property-label"><g:message default="Lng" /></span>
				...
				<li class="fieldcontain">
					<span id="mplat-label" class="property-label"><g:message default="Lat" /></span>
				...
				<li class="fieldcontain">
					<span id="mpzoom-label" class="property-label"><g:message default="Zoom" /></span>
